...
class Transaction {
  ...
  get(tid) {
    ...
    const response = this.request(OPERATIONS.REPORT, { transactionId: tid });
  ...
  capture(tid) {
    ...
    const response = this.request(OPERATIONS.CAPTURE, { transactionId: tid });
  ...
  cancel(tid) {
    ...
    const response = this.request('cancel', { transactionId: tid });
  ...
  boleto(data) {
    ...
    const response = this.request(OPERATIONS.boleto, data);
